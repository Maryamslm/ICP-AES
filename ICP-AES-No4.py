...
data = {
    'Co': {
        ...
        'LAC 7D':    ([1.422, 1.735, 1.853, 1.951, 1.196, 1.314, 1.304, 1.520], [0.001]*8),
        'LAC 1M':    ([1.873, 1.951, 2.069, 2.294, 1.088, 1.304, 1.324, 1.520], [0.010, 0.010, 0.029, 0.029, 0.020, 0.010, 0.020, 0.010]),
    },
    'Cr': {
        ...
        'LAC 7D':    ([0.873, 0.093, 0.097, 0.108, 0.073, 0.078, 0.075, 0.083], [0.002]*8),
        'LAC 1M':    ([0.099, 0.109, 0.207, 0.227, 0.092, 0.096, 0.066, 0.070], [0.002, 0.002, 0.002, 0.001, 0.001, 0.001, 0.001, 0.001]),
    },
    'W': {
        ...
        'LAC 7D':    ([0.068, 0.073, 0.084, 0.086, 0.043, 0.047, 0.050, 0.054], [0.001]*8),
        'LAC 1M':    ([0.075, 0.083, 0.083, 0.089, 0.054, 0.059, 0.056, 0.064], [0.001, 0.002, 0.002, 0.001, 0.001, 0.001, 0.001, 0.001]),
    },
    'Mo': {
        ...
        'LAC 7D':    ([0.045, 0.048, 0.050, 0.053, 0.022, 0.028, 0.032, 0.040], [0.001, 0.002, 0.001, 0.002, 0.001, 0.001, 0.001, 0.001]),
        'LAC 1M':    ([0.037, 0.044, 0.048, 0.054, 0.025, 0.029, 0.022, 0.030], [0.001]*8),
    },
    'Si': {
        'Ringer 7D': None,
        'Ringer 1M': ([0.012, 0.019, 0.020, 0.021, 0.009, 0.010, 0.010, 0.020], [0.001]*8),
        'LAC 7D':    ([0.033, 0.037, 0.043, 0.050, 0.022, 0.028, 0.028, 0.030], [0.001]*8),
        'LAC 1M':    ([0.054, 0.068, 0.064, 0.071, 0.048, 0.054, 0.041, 0.048], [0.001, 0.001, 0.002, 0.002, 0.001, 0.001, 0.001, 0.001]),
    },
    'Al': {
        'Ringer 7D': None,
        'Ringer 1M': ([0.009, 0.010, 0.010, 0.015, None, None, None, None], [0.001, 0.001, 0.001, 0.001, None, None, None, None]),
        'LAC 7D':    None,
        'LAC 1M':    ([0.022, 0.025, 0.028, 0.030, 0.012, 0.015, 0.022, 0.027], [0.001]*8),
    },
}

# ── Publication Style Presets ───────────────────────────────────────────────
# All facecolor/edgecolor values are strict hex strings to prevent st.color_picker crashes
PUBLICATION_STYLES = {
